  ...
  return (
    ...
    >
      <div className="mb-4 relative">
        <div className="w-[175px] sm:w-[180px] md:w-[180px] lg:w-[220px] xl:w-[240px] 2xl:w-[283px] h-[170px] sm:h-[182px] relative">
          <img
            src={IMG_CARD_URL_2 + topRes?.cloudinaryImageId}
            alt={topRes?.name}
            className="w-[175px] sm:w-[180px] md:w-[180px] lg:w-[220px] xl:w-[240px] 2xl:w-[283px] h-[170px] sm:h-[182px] object-cover rounded-xl"
          />
        ...
        <h2 className="mt-3 ml-0 sm:ml-2 font-semibold text-xl truncate max-w-[140px] sm:max-w-[170px] md:max-w-[170px] lg:max-w-[160px] xl:max-w-[230px] 2xl:max-w-[260px]">
          {topRes?.name}
        </h2>
        ...
        <p className="ml-0 sm:ml-2 mt-1 truncate max-w-[140px] sm:max-w-[170px] md:max-w-[170px] lg:max-w-[160px] xl:max-w-[230px] 2xl:max-w-[260px]">
          {topRes?.cuisines?.join(", ")}
        </p>
        <p className="ml-0 sm:ml-2 truncate max-w-[140px] sm:max-w-[170px] md:max-w-[170px] lg:max-w-[160px] xl:max-w-[230px] 2xl:max-w-[260px]">
          {topRes?.locality}
        </p>
      </div>
    </Link>
