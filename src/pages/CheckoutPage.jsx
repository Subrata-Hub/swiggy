...
const CheckoutPage = () => {
  ...
  return (
    <div
      className={`${
        showNavigation ? "mt-28" : "mt-28"
      }mx-1 sm:mx-[40px] md:mx-[30px] lg:mx-[50px] xl:mx-[140px]`}
    >
      <div className="flex flex-col lg:flex-row justify-between gap-4">
        ...
        <div
          className={`mr-0 lg:mr-32 xl:mr-15 2xl:mr-15 w-full sm:w-1/4 order-1 lg:order-none px-0 sm:px-20 md:px-32 lg:px-0 ${
            showNavigation ? "mt-20" : "mt-0"
          }`}
        >
          <CheckOutCart />
        </div>
